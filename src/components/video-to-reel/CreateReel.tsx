  ...
  <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
    <div className="bg-white rounded-2xl p-8 flex flex-col items-center space-y-6 max-w-sm w-full mx-4">
      ...
      <div className="space-y-2 text-center">
        ...
        <p className="text-gray-500">Please wait while we create your perfect reel...</p>
      </div>
  ...
  const pollProjectStatus = async (projectId: number, attempt = 1) => {
    ...
    try {
      ...
      const response = await axios.get(
        `https://kimchi-new.yellowpond-c706b9da.westus2.azurecontainerapps.io/poll_project/14877211`,
        {
          headers: {
