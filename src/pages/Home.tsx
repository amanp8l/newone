      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="group relative rounded-2xl transition-all duration-300 hover:scale-[1.02] min-h-[500px]">
            ...
            <div className={`relative ${isDark ? 'bg-gray-800' : 'bg-white'} rounded-2xl p-8 h-full flex flex-col`}>
              ...
              <h2 className={`text-2xl font-bold ${isDark ? 'text-gray-100' : 'text-indigo-900'} mb-4`}>Quick Post</h2>
              <p className={`text-lg ${isDark ? 'text-gray-300' : 'text-indigo-600'} mb-6`}>
                Create and publish content quickly across multiple platforms with AI assistance.
              </p>

              <div className="space-y-4 mb-8 flex-grow">
                <div className={`flex items-center space-x-3 ${isDark ? 'text-gray-300' : 'text-indigo-600'}`}>
                  <div className={`w-8 h-8 rounded-lg ${isDark ? 'bg-gray-700' : 'bg-gradient-to-br from-indigo-50 to-pink-50'} flex items-center justify-center flex-shrink-0`}>
          ...
          <div className="group relative rounded-2xl transition-all duration-300 hover:scale-[1.02] min-h-[500px]">
            ...
            <div className={`relative ${isDark ? 'bg-gray-800' : 'bg-white'} rounded-2xl p-8 h-full flex flex-col`}>
              ...
              <h2 className={`text-2xl font-bold ${isDark ? 'text-gray-100' : 'text-indigo-900'} mb-4`}>Create Campaign</h2>
              <p className={`text-lg ${isDark ? 'text-gray-300' : 'text-indigo-600'} mb-6`}>
